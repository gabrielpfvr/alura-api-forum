...
public class TopicsController {
	...
	public ResponseEntity<TopicDto> create(@RequestBody @Valid TopicForm form, UriComponentsBuilder uriBuider) {
		Topic topic = form.convert(courseRepository);
		topicRepository.save(topic);

		URI uri = uriBuider.path("/topicos/{id}").buildAndExpand(topic.getId()).toUri();
